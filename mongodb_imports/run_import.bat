...
REM mongoimport mongodb://localhost:27017 --drop --stopOnError --type=json --jsonArray --db=mycrm --collection=computedDurations --file=computedDurations.json
mongoimport mongodb://localhost:27017 --drop --stopOnError --type=json --jsonArray --db=mycrm --collection=projects --file=projects.json
