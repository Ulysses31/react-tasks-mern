...
export default function SideBar() {
  ...
  const tasks = useSelector(
    (state) => state.taskState.tasks
  );
  const activeProjects = useSelector(
    (state) => state.projectState.activeProjects
  );
  const activeTasks = useSelector(
    (state) => state.taskState.activeTasks
  );
  ...
  useEffect(() => {
    dispatch(getActiveProjects()).then(() =>
  ...
  return (
    ...
    >
      <div className='sidebar-header shadow-sm'>
        <span id='logo'>React Projects - Tasks</span>
      </div>
      <div id='userAvatar'>
        <img
          ...
          <>
            ...
            <li>
              ...
              >
                <li>
                  <Link
                    to='/settings/computeduration'
                    className={
                      'sideBarLink ' +
                      (location.pathname ===
                        '/settings/computeduration' ||
                      location.pathname ===
                        '/settings/computeduration/add'
                        ? 'active'
                        : '')
                    }
                    aria-current='true'
